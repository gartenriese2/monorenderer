...
int main() {
	...
	renderer::rt::Quad wallLeft({-5.f, -5.f, 0.f}, {-5.f, -5.f, -10.f}, {-5.f, 5.f, -10.f}, {-5.f, 5.f, 0.f});
	renderer::rt::Quad wallDown({-5.f, -5.f, 0.f}, {5.f, -5.f, 0.f}, {5.f, -5.f, -10.f}, {-5.f, -5.f, -10.f});
	renderer::rt::Quad wallRight({5.f, -5.f, -10.f}, {5.f, -5.f, 0.f}, {5.f, 5.f, 0.f}, {5.f, 5.f, -10.f});
	renderer::rt::Quad wallUp({-5.f, 5.f, -10.f}, {5.f, 5.f, -10.f}, {5.f, 5.f, 0.f}, {-5.f, 5.f, 0.f});
	renderer::rt::Quad wallBack({-5.f, -5.f, -10.f}, {5.f, -5.f, -10.f}, {5.f, 5.f, -10.f}, {-5.f, 5.f, -10.f});
